...
<header data-header class="fixed inset-x-0 z-[30] transition-all duration-300">
  <div class="container flex items-center justify-between h-20">
    ...
    <a href="{{ qazaqstan_url('/') }}" class="header-logo transition-opacity duration-300 select-none" aria-label="{{ __('QAZAQSTAN Resort — главная', 'qazaqstan') }}">
      @include('partials.logo')
    </a>

    <nav class="hidden lg:flex items-center gap-4" aria-label="{{ __('Главное меню', 'qazaqstan') }}">
      <a href="{{ qazaqstan_url('/about/') }}" class="header-nav-link">{{ __('О санатории', 'qazaqstan') }}</a>
      ...
      <div class="header-dropdown-wrap">
        ...
        <div class="header-dropdown" role="menu">
          <a href="{{ qazaqstan_url('/treatment/') }}" role="menuitem">
          ...
          <a href="{{ qazaqstan_url('/sport/') }}" role="menuitem">
          ...
          <a href="{{ qazaqstan_url('/services/') }}" role="menuitem">
      ...
      <div class="header-dropdown-wrap">
        ...
        <div class="header-dropdown" role="menu">
          <a href="{{ qazaqstan_url('/blog/') }}" role="menuitem">
            <span class="header-dropdown__icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></span>
            {{ __('Блог и новости', 'qazaqstan') }}
          </a>
          <a href="{{ qazaqstan_url('/vacancies/') }}" role="menuitem">
          ...
          <a href="{{ qazaqstan_url('/procurement/') }}" role="menuitem">
      ...
      <div class="header-dropdown-wrap">
        ...
        <div class="header-dropdown" role="menu">
          <a href="{{ qazaqstan_url('/accommodation/') }}" role="menuitem">
          ...
          <a href="{{ qazaqstan_url('/conferences/') }}" role="menuitem">
          ...
          <a href="{{ qazaqstan_url('/gallery/') }}" role="menuitem">
      ...
      <a href="{{ qazaqstan_url('/anti-corruption/') }}" class="header-nav-link">{{ __('Антикоррупция', 'qazaqstan') }}</a>
      <a href="{{ qazaqstan_url('/contacts/') }}" class="header-nav-link">{{ __('Контакты', 'qazaqstan') }}</a>
    </nav>

    <div class="flex items-center gap-2 md:gap-3">
      <div class="header-lang hidden md:flex">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="flex-shrink-0"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
        @if(!empty($langSwitch))
          @foreach($langSwitch as $slug => $url)
            @if(!$loop->first)<span class="header-lang__sep" aria-hidden="true">/</span>@endif
      ...
      <a href="{{ qazaqstan_url('/booking/') }}" class="header-cta btn btn--sm rounded-md font-bold text-[13px]">{{ __('Забронировать', 'qazaqstan') }}</a>
...
<aside data-menu-drawer class="fixed inset-0 z-[50] bg-white translate-x-full transition-transform duration-300 ease-out lg:hidden [&.is-open]:translate-x-0 overflow-y-auto" aria-label="{{ __('Мобильное меню', 'qazaqstan') }}">
  <div class="container flex items-center justify-between h-20 border-b border-warm-grey">
    <a href="{{ qazaqstan_url('/') }}" class="select-none" aria-label="{{ __('На главную', 'qazaqstan') }}">
  ...
  <nav class="container flex flex-col mt-4 pb-8 text-charcoal" aria-label="{{ __('Мобильное меню', 'qazaqstan') }}">
    ...
    <a href="{{ qazaqstan_url('/') }}"                class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Главная', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/about/') }}"           class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('О санатории', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/contacts/') }}"        class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Контакты', 'qazaqstan') }}</a>
    <p class="text-[11px] font-bold uppercase tracking-widest text-soft-grey mt-5 mb-1">{{ __('Услуги', 'qazaqstan') }}</p>
    <a href="{{ qazaqstan_url('/treatment/') }}"       class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Лечение', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/sport/') }}"           class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Спорт и бассейн', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/services/') }}"        class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Доп. услуги', 'qazaqstan') }}</a>
    <p class="text-[11px] font-bold uppercase tracking-widest text-soft-grey mt-5 mb-1">{{ __('Инфраструктура', 'qazaqstan') }}</p>
    <a href="{{ qazaqstan_url('/accommodation/') }}"   class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Номера', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/conferences/') }}"     class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Конференц-залы', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/gallery/') }}"         class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Галерея', 'qazaqstan') }}</a>
    <p class="text-[11px] font-bold uppercase tracking-widest text-soft-grey mt-5 mb-1">{{ __('Пресс-центр', 'qazaqstan') }}</p>
    <a href="{{ qazaqstan_url('/blog/') }}"            class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Блог и новости', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/vacancies/') }}"       class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Вакансии', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/procurement/') }}"     class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Госзакупки', 'qazaqstan') }}</a>
    <a href="{{ qazaqstan_url('/anti-corruption/') }}" class="py-3 border-b border-warm-grey font-display font-bold text-base uppercase tracking-wide hover:text-klein-blue transition-colors">{{ __('Антикоррупция', 'qazaqstan') }}</a>

    @if(!empty($langSwitch))
    <div class="header-lang mt-6">
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" class="flex-shrink-0"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
      @foreach($langSwitch as $slug => $url)
        @if(!$loop->first)<span class="header-lang__sep" aria-hidden="true">/</span>@endif
        <a href="{{ esc_url($url) }}" class="header-lang__btn {{ $currentLang === $slug ? 'is-active' : '' }}" hreflang="{{ $slug }}">
    ...
    <div class="mt-6 flex flex-col gap-3">
      <a href="{{ qazaqstan_url('/booking/') }}"                  class="btn btn--primary btn--lg w-full justify-center">{{ __('Забронировать путёвку', 'qazaqstan') }}</a>
